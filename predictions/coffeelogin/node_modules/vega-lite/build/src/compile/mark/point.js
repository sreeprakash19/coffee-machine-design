...
function encodeEntry(model, fixedShape) {
    ...
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, encode.baseEncodeEntry(model, {
        ...
        size: 'include',
        orient: 'ignore'
    })), encode.pointPosition('x', model, { defaultPos: 'mid' })), encode.pointPosition('y', model, { defaultPos: 'mid' })), encode.nonPosition('size', model)), shapeMixins(model, config, fixedShape));
}
