import { Axis as VgAxis, AxisEncode, AxisOrient, BaseAxis, Color, FontStyle, FontWeight, LabelOverlap, TextBaseline } from 'vega';
...
export declare type VgAxisConfigNoSignals = Omit<BaseAxisNoValueRefs, ConditionalAxisProp> & {
